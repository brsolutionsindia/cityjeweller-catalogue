...
import { getPendingRudrakshaQueue } from "@/lib/firebase/rudrakshaAdminDb";
    ...
    <div className="p-6 max-w-6xl mx-auto space-y-5">
      <div className="flex items-center justify-between gap-3">
        <div>
          ...
          <div className="text-2xl font-bold mt-1">Rudraksha Approvals</div>
      ...
      <div className="rounded-2xl border bg-white p-4 shadow-sm">
        ...
        {!busy && filtered.length === 0 && <div className="text-sm text-gray-600">No pending rudraksha submissions.</div>}
      </div>
    </div>
  );
}
