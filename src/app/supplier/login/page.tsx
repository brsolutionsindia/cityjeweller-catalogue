  ...
  return (
    <main className="p-6 max-w-sm mx-auto">
      ...
      <form onSubmit={onLogin} className="flex flex-col gap-3">
        ...
        <input className="border p-2 rounded" type="password" placeholder="Password" value={pass} onChange={e=>setPass(e.target.value)} />
        <button className="border p-2 rounded">Login</button>
      </form>
